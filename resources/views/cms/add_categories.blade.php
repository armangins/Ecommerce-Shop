...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
    <form enctype="multipart/form-data" autocomplete="off" action="{{url('cms/categories')}}" method="POST">
        @csrf
        <div class="col-6">
            @if ($errors)
            <div class="form-group">
                <label for="formGroupExampleInput2">New category:</label>
                <input value="{{old('title')}}" name="title" type="text" class="form-control original-text" id="formGroupExampleInput2"
